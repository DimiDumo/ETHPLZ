...
Moralis.Cloud.define("circle_publicKey", async (request) => {
...
Moralis.Cloud.define("circle_addCard", async (request) => {
...
Moralis.Cloud.define("circle_pay", async (request) => {
...
Moralis.Cloud.define("circle_paymentStatus", async (request) => {
